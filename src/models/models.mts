...
type DatabaseConnectionSslCertificatePath = { sslCertificatePath?: string };
type DatabaseConnectionSslCertificate = { sslCertificate?: string };
type DatabaseConnectionOptionsNoCert = {
...
export type DatabaseConnectionOptions = DatabaseConnectionOptionsNoCert &
  (DatabaseConnectionSslCertificatePath | DatabaseConnectionSslCertificate);

export type StandardizedDatabaseConnectionOptions = DatabaseConnectionOptionsNoCert & DatabaseConnectionSslCertificate;
